...
[![NPM](https://img.shields.io/npm/v/@salesforce/plugin-multiframework-dev.svg?label=@salesforce/plugin-multiframework-dev)](https://www.npmjs.com/package/@salesforce/plugin-multiframework-dev) [![Downloads/week](https://img.shields.io/npm/dw/@salesforce/plugin-multiframework-dev.svg)](https://npmjs.org/package/@salesforce/plugin-multiframework-dev) [![License](https://img.shields.io/badge/License-Apache--2.0-blue.svg)](https://opensource.org/license/apache-2-0)
...
1. **Install the plugin:**
   ...
   ```bash
   sf plugins install @salesforce/plugin-multiframework-dev
   ```
...
📚 **[Complete Guide](SF_MULTI_FRAMEWORK_DEV_GUIDE.md)** - Comprehensive documentation covering:
...
```bash
sf plugins install @salesforce/plugin-multiframework-dev@x.y.z
```
...
git clone git@github.com:salesforcecli/plugin-multiframework-dev
...
```bash
USAGE
  $ sf multi-framework dev --name <webapp-name> --target-org <org-alias> [options]
...
SEE ALSO
  - Complete Guide: SF_MULTI_FRAMEWORK_DEV_GUIDE.md
```
