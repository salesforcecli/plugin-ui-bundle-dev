...
[![NPM](https://img.shields.io/npm/v/@salesforce/plugin-multiframework.svg?label=@salesforce/plugin-multiframework)](https://www.npmjs.com/package/@salesforce/plugin-multiframework) [![Downloads/week](https://img.shields.io/npm/dw/@salesforce/plugin-multiframework.svg)](https://npmjs.org/package/@salesforce/plugin-multiframework) [![License](https://img.shields.io/badge/License-Apache--2.0-blue.svg)](https://opensource.org/license/apache-2-0)
...
1. **Install the plugin:**
   ...
   ```bash
   sf plugins install @salesforce/plugin-multiframework
   ```
...
📚 **[Complete Guide](SF_MULTI_DEV_GUIDE.md)** - Comprehensive documentation covering:
...
```bash
sf plugins install @salesforce/plugin-multiframework@x.y.z
```
...
git clone git@github.com:salesforcecli/plugin-multiframework
...
```bash
USAGE
  $ sf multi dev --name <webapp-name> --target-org <org-alias> [options]
...
SEE ALSO
  - Complete Guide: SF_MULTI_DEV_GUIDE.md
```
